...
<body>
    <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
        ...
        <ul class="menu-inner py-1">
            ...
            {{-- carousal --}}
            <li class="menu-item">
                <a href="{{ route('carasoul.index') }}" class="menu-link">
            ...
            {{-- extrafield --}}
            <li class="menu-item">
                <a href="{{ route('extrafields.index') }}" class="menu-link">
                    <div data-i18n="Analytics">Extrafield</div>
                </a>
            </li>
            ...
            <div class="layout-page">
                <div class="content-wrapper">
                    <div class="container-xxl flex-grow-1 container-p-y">
                        @yield('carousel-index')
                        @yield('carousel-create')
                        @yield('carousel-edit')
